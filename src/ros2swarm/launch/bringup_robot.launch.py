...
def generate_launch_description():
    ...
    launch_file_dir_ugv = os.path.join(get_package_share_directory('ugv_bringup'), 'launch')
    ...
    urdf_file = os.path.join(get_package_share_directory('ugv_description'), 'urdf', urdf_file_name)

    config_dir = os.path.join(get_package_share_directory('ros2swarm'), 'config', robot_type) #TODO choose right config
